    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img.src !== (img_src_value = "memoji-421x421.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "Memoji");
    			attr_dev(img, "width", "421");
    			attr_dev(img, "height", "421");
    			attr_dev(img, "class", "svelte-cmqlpq");
    			add_location(img, file$4, 6, 4, 105);
    			attr_dev(h1, "class", "svelte-cmqlpq");
    			add_location(h1, file$4, 7, 4, 180);
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			span = element("span");
    			t = text(t_value);
    			attr_dev(span, "class", "svelte-3j4xkg");
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "tags svelte-3j4xkg");
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "width", "1024");
    			attr_dev(img, "height", "768");
    			attr_dev(img, "class", "svelte-1v9o1rb");
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "title svelte-1v9o1rb");
    			add_location(span0, file$6, 30, 8, 743);
    			attr_dev(span1, "class", "subtitle svelte-1v9o1rb");
    			add_location(span1, file$6, 31, 8, 786);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			create_component(linkwrapper.$$.fragment);
    			attr_dev(span, "class", "separator svelte-1v9o1rb");
    			add_location(span, file$6, 40, 8, 1044);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text("Source\n            ");
    			create_component(icon.$$.fragment);
    			attr_dev(div, "class", "icon-wrapper svelte-1v9o1rb");
    			add_location(div, file$6, 42, 10, 1125);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "top svelte-1v9o1rb");
    			add_location(div0, file$6, 28, 4, 691);
    			attr_dev(time, "datetime", /*machineDate*/ ctx[8]);
    			add_location(time, file$6, 36, 6, 914);
    			attr_dev(div1, "class", "bottom svelte-1v9o1rb");
    			add_location(div1, file$6, 35, 4, 887);
    			attr_dev(div2, "class", "caption svelte-1v9o1rb");
    			add_location(div2, file$6, 27, 2, 665);
