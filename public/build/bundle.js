...
var app = (function () {
    ...
    const blobs = new Map([
      ...
      [
        'mail-back',
        'M43.5,-62.1C55.3,-51.3,62.9,-37.1,69.7,-21.4C76.5,-5.7,82.5,11.5,80.4,28.7C78.4,45.8,68.3,63,53.5,74.4C38.8,85.8,19.4,91.5,2.4,88.2C-14.6,84.9,-29.2,72.6,-40.1,59.9C-50.9,47.2,-58.1,34.2,-65.9,19.3C-73.8,4.3,-82.4,-12.6,-79.2,-26.8C-76.1,-41,-61.2,-52.4,-46.1,-62.1C-30.9,-71.8,-15.5,-79.7,0.2,-80C15.9,-80.3,31.7,-72.9,43.5,-62.1Z',
      ],
      [
        'twitter-front',
        'M45.3,-63.4C56.8,-54.1,62.7,-38.2,63.8,-23.4C64.8,-8.7,61,5,54.8,15.8C48.5,26.7,39.8,34.8,30.3,39.3C20.8,43.9,10.4,45,-4.6,51.3C-19.6,57.6,-39.2,69.2,-48.7,64.7C-58.3,60.1,-57.9,39.4,-61.9,21.4C-66,3.4,-74.5,-11.8,-74,-27.3C-73.5,-42.9,-63.9,-58.9,-50.1,-67.4C-36.2,-75.9,-18.1,-77,-0.6,-76.2C17,-75.4,33.9,-72.7,45.3,-63.4Z',
      ],
      [
        'twitter-back',
        'M47.8,-63C63,-54.8,77.1,-42.2,82.6,-26.5C88.1,-10.9,85.1,7.9,78.8,25.1C72.5,42.2,62.9,57.8,49.2,68.5C35.5,79.2,17.8,85.1,1.9,82.5C-14,79.9,-27.9,68.8,-38,56.9C-48.2,45,-54.4,32.4,-60.4,18.6C-66.4,4.7,-72,-10.3,-68.3,-22.3C-64.6,-34.4,-51.5,-43.6,-38.5,-52.6C-25.6,-61.5,-12.8,-70.2,1.8,-72.6C16.3,-75,32.6,-71.2,47.8,-63Z',
      ],
      [
        'github-front',
        'M48.6,-64.5C63.6,-56,76.7,-42.6,77.7,-28C78.7,-13.4,67.5,2.5,60,17.7C52.6,32.9,48.8,47.5,39.4,56.6C30.1,65.6,15,69.2,-0.7,70.1C-16.3,71,-32.7,69.3,-44.1,60.8C-55.5,52.4,-62.1,37.3,-62.6,23.3C-63.1,9.2,-57.7,-3.9,-55.7,-20.5C-53.6,-37.2,-55,-57.4,-46.3,-68C-37.6,-78.6,-18.8,-79.7,-1,-78.3C16.8,-77,33.6,-73.1,48.6,-64.5Z',
      ],
      [
        'github-back',
        'M48.4,-63.6C64.1,-55.2,79.1,-42.9,84.1,-27.4C89.1,-11.8,84.1,6.9,77.1,24C70.1,41.1,61.2,56.5,48,65.3C34.8,74.1,17.4,76.3,1,74.9C-15.4,73.5,-30.7,68.5,-41.7,59C-52.7,49.4,-59.2,35.4,-65.9,20.1C-72.6,4.9,-79.4,-11.6,-77.1,-26.9C-74.7,-42.3,-63.1,-56.5,-48.7,-65.4C-34.3,-74.2,-17.1,-77.7,-0.4,-77.1C16.4,-76.6,32.7,-72,48.4,-63.6Z',
      ],
    ]);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file$1, 7, 2, 129);
    			attr_dev(svg, "class", svg_class_value = "icon " + /*type*/ ctx[0] + " svelte-j0l59w");
    			attr_dev(svg, "viewBox", "0 0 512 512");
    			add_location(svg, file$1, 6, 0, 79);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*type*/ 1 && svg_class_value !== (svg_class_value = "icon " + /*type*/ ctx[0] + " svelte-j0l59w")) {
    				attr_dev(svg, "class", svg_class_value);
    			}
    		},
    		i: noop,
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-jihove");
    			add_location(img, file$4, 6, 4, 105);
    			attr_dev(h1, "class", "svelte-jihove");
    			add_location(h1, file$4, 7, 4, 173);
    			attr_dev(div, "class", "brand svelte-jihove");
    			add_location(div, file$4, 5, 2, 81);
    			attr_dev(header, "class", "svelte-jihove");
